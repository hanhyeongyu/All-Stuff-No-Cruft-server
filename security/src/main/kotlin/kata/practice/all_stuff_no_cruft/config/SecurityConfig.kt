...
import kata.practice.all_stuff_no_cruft.jwt.JwtProvider
    ...
    fun securityFilterChain(
        ...
        http{
            ...
            authorizeHttpRequests {
                ...
                authorize("/organizer/signup", permitAll)
                authorize("/organizer/issue/**", permitAll)
                authorize("/organizer/**", hasRole("ORGANIZER"))

                authorize("/speaker/signup", permitAll)
                authorize("/speaker/issue/**", permitAll)
                authorize("/speaker/**", hasRole("SPEAKER"))

                authorize("/conferences/**", permitAll)
                authorize("/talks/**", permitAll)

                authorize("/videos/**", permitAll)
                authorize("/video_hsl/**", permitAll)
                authorize("/images/**", permitAll)
                authorize("/pdfs/**", permitAll)
